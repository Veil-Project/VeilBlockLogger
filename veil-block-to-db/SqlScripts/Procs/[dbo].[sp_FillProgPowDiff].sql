...
CREATE PROCEDURE [dbo].[sp_FillProgPowDiff] 
AS
BEGIN

	DECLARE @StartBlock bigint = (SELECT ISNULL(MAX(BLOCKID),0) + 1 FROM bak.ProgPowDiffHistory);
	DECLARE @BlockType int = 34; 
	SELECT BDO.BlockID, 
	...
	INSERT INTO bak.ProgPowDiffHistory(BlockID,PowDiff,Ma720Blocks,Ma1440Blocks, Ma4320Blocks, Ma10080Blocks)	
		SELECT BDO.BlockID,
		BDO.PowDiff,	
